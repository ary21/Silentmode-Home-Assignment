...
Note: This project is a Proof of Concept (PoC) designed for assessment purposes and is not intended for production use. A production-grade implementation would require stack adjustments, such as :
- deploying on physical client hardware
- utilizing managed object storage, e.g: AWS S3 or Google Cloud Storage for Object storage.
